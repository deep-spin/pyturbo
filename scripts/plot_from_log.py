...
if __name__ == '__main__':
    ...
    parser.add_argument('--names', nargs='+',
                        help='Names of the plots. If not given, filenames will '
                             'be used')
    parser.add_argument('--pos', help='Legend position', default='lower right')
